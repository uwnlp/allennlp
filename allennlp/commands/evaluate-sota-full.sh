...
python -m allennlp.run evaluate --archive-file ./sota_logs/mnli_hard/model.tar.gz --evaluation-data-file $DATA_DIR/matched_dev_easy.json
python -m allennlp.run evaluate --archive-file ./sota_logs/mnli_hard/model.tar.gz --evaluation-data-file $DATA_DIR/matched_dev_hard.json

python -m allennlp.run evaluate --archive-file ./sota_logs/mnli_hard/model.tar.gz --evaluation-data-file $DATA_DIR/mismatched_dev_easy.json
python -m allennlp.run evaluate --archive-file ./sota_logs/mnli_hard/model.tar.gz --evaluation-data-file $DATA_DIR/mismatched_dev_hard.json

python -m allennlp.run evaluate --archive-file ./sota_logs/mnli_hard/model.tar.gz --evaluation-data-file $DATA_DIR/matched_dev_full.json
python -m allennlp.run evaluate --archive-file ./sota_logs/mnli_hard/model.tar.gz --evaluation-data-file $DATA_DIR/mismatched_dev_full.json
